...
//
//    @Override
//    public List<User> selectAllUsersUsingCallableStatement() {
...
//    }
//    @Override
//    public List<User> selectAllUsersByCountry(String country) throws SQLException {
//        List<User> users = new ArrayList<>();
//        try (Connection connection = getConnection();
...
//                users.add(new User(id, name, email, country_name));
//            }
//        } catch (SQLException e) {
//            printSQLException(e);
//        }
...
//        List<User> users = new ArrayList<>();
//        try (Connection connection = getConnection();
//             PreparedStatement preparedStatement = connection.prepareStatement(SELECT_USER_BY_NAME_WITH_ORDER);) {
//
//            ResultSet rs = preparedStatement.executeQuery();
//
//            while (rs.next()) {
